...
class ChecklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post checklists_url, params: { checklist: { name: @checklist.name, task_id: @checklist.task_id } }
    end
  ...
  test "should update checklist" do
    patch checklist_url(@checklist), params: { checklist: { name: @checklist.name, task_id: @checklist.task_id } }
